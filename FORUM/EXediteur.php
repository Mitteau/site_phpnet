...
<input type="button" id="rouge" name="rouge" value="rouge" onClick="javascript:bbcode('[red]', '[/red]');return(false)" />
<input type="button" id="image" name="image" value="image" onClick="javascript:bbcode('[img=', ']');return(false)" />
...
<fieldset><legend>Message</legend><textarea cols="84" rows="8" id="message" name="message"></textarea></fieldset>
